...
public class AngleTest {
    ...
    class StringConversionTests {
        ...
        /**
         * Тест для метода toString, который возвращает строку угла в градусах с двумя знаками после запятой.
         */
    ...
    // 1. **Сложение**: Проверка сложения углов в градусах и радианах, особенно при переходе через границу диапазона
    @Nested
    class AdditionTests {
    ...
    // 2. **Вычитание**: Проверка вычитания углов в градусах и радианах, особенно при переходе через границу диапазона
    @Nested
    ...
    // 1. **Сравнение углов**: Проверка метода compare для сравнения углов
    @Nested
    ...
    // 1. **Тип угла**: Проверка метода determineAngleType для определения типа угла
    @Nested
    ...
    // 1. **Создание копии объекта**: Проверка на равенство копий, иммутабельность и совпадение hashCode
    @Nested
    class CopyTests {
    ...
    // 1. **Невалидные значения**: Тестирование на передаче углов за пределами допустимого диапазона
    @Nested
    ...
    // 2. **Проверка исключений**: Тестирование на выбрасывание исключений для различных недопустимых случаев
    @Nested
    ...
    // 3. **Проверка формул**: Тестирование корректности формул перевода между градусами и радианами
    @Nested
    class FormulaTests {
    ...
    // 4. **Граничные случаи**: Тестирование углов на границах допустимого диапазона
    @Nested
    class BoundaryTests {
